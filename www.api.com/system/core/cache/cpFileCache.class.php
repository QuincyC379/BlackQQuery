...
class cpFileCache
{
    ...
    public $config = array();
        private $idx_node_size = 40; //40+20+24*16+16*16*16*16*4;
private $data_base_pos = 262588;
        private $schema_item_size = 24; //保留空间 放置php标记防止下载
    private $header_padding = 20; //保留空间 4+16 maxsize|ver

    //40起 添加20字节保留区域
    private $info_size = 20; //id 计数器节点地址
    private $idx_seq_pos = 40; //id 计数器节点地址
    private $dfile_cur_pos = 44; //id 空闲链表入口地址
private $idx_free_pos = 48; //40+20+24*16
